...
const Services = () => {
    return (
        <section>
            ...
            <h6 className='gray-3 text-center mb-5'>Специальность</h6>
            ...
            <div className="box">
                ...
                <button type='button' className='btn-1 py-3 px-5 mt-4'>
                    <IoAddOutline className='fs-15 me-1'/>
                    <span>Добавить</span>
                </button>
            </div>

            <form className="box form-about-info mt-5">
                <fieldset>
                ...
                <button type='submit' className='btn-1 px-5'>Сохранить</button>
            </form>
            ...
            <form className="box form-about-info mt-5">
                ...
                <button type='button' className='btn-1 px-5 mt-4'>Запустить</button>
            </form>
            ...
            <form className="box form-about-info mt-5">
                ...
                <button type='button' className='btn-1 px-5 mt-4'>Сохранить</button>
            </form>

            <Link to='/account' className='btn-4 mx-auto mt-5'>
