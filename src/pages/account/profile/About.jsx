        ...
        <section>
            ...
            <form action="" className='form-about-info box' onSubmit={handleSubmit(onEditAccount)}>
                <fieldset>
                    ...
                    <textarea rows="6" placeholder='Расскажите о себе' defaultValue={data?.about} onChange={(e) => { setValue("about", e.target.value) }}></textarea>
                ...
                <button type='submit' className='btn-3 w-xs-100'>Сохранить</button>
            </form>
