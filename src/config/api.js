...
const apiRoutes = {
  ...
  // Category
  SUBSCRIPTIONS: BASE_URL + "/subscription/all",
  ...
  // Product
  PRODUCT: BASE_URL + "/ads/one",
  USER_PRODUCTS: BASE_URL + "/ads",
  USER_PRODUCT: BASE_URL + "/ads/one",
  ...
  USER_AUTH: BASE_URL + "/user/auth/one",
  ...
  //Task
  TASK_ONE: BASE_URL + "/user/task/one",
